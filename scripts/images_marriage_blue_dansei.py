"""
「結婚がリアルになってきて、なんだか気分が重い」——そんなあなたへ。
...
DRAFT_ID    = "d62fc137-2e3b-494b-bf2f-c4a121f342c4"
...
IMAGE_PROMPTS = [
    {
        ...
        "prompt": (
            ...
            "He sits quietly alone, elbows on knees, thoughtful heavy expression looking downward, "
            "soft natural window light, minimalist modern room."
        ),
        "caption": "結婚がリアルになってきて、なんだか気分が重い",
        "filename": "2026-08-06_marriage_blue_dansei_eyecatch.png",
    },
    {
        "name": "walk",
        "prompt": (
            "Photorealistic, cinematic quality, natural soft lighting, East Asian appearance, black hair, "
            "a Japanese man in his 30s walking alone outdoors, hands in pockets, contemplative expression, "
            "soft evening light, real-world setting, professional lifestyle photography style, "
            "shallow depth of field, clean bright atmosphere, no text, no warm yellowish tint."
        ),
        "caption": "誰にとっても、まったく新しい世界に進むのは怖いものです",
        "filename": "2026-08-06_marriage_blue_dansei_walk.png",
    },
    {
        "name": "couple",
        "prompt": (
            "Photorealistic, cinematic quality, natural soft lighting, East Asian appearance, black hair, "
            "a Japanese couple in their 30s sitting close together on a sofa, the man speaking honestly "
            "while the woman listens warmly, gentle genuine expressions, real-world setting, "
            "professional lifestyle photography style, shallow depth of field, clean bright modern "
            "living room, no text, no warm yellowish tint."
        ),
        "caption": "弱音を吐くことは、弱さじゃありません",
        "filename": "2026-08-06_marriage_blue_dansei_couple.png",
    },
]
...
def main():
    ...
    insert_after = [
        ("——そんな感覚、ありませんか。それ、実は\"ビビってる\"のかもしれません。今日はその正体についてお話ししたいと思います。", "eyecatch"),
        ("不安というのは、不確かさから生まれるものです。一人で抱えて誰にも話さないままだと、不確かさはいつまでも減らないので、不安もプレッシャーも、そのまま続いてしまいます。", "walk"),
        ("一人で不安を抱え込まないでください。仲人にも相談してください。先に結婚した友人や、ご両親も、結婚の先輩です。話を聞いてみてください。そしてもちろん、公認心理師の私にも、いつでも相談してください。", "couple"),
    ]
